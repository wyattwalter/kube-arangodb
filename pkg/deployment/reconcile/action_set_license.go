...
func (a *licenseSetAction) Start(ctx context.Context) (bool, error) {
	...
	l, ok := k8sutil.GetLicenseFromSecret(a.actionCtx.GetCachedStatus(), spec.Authentication.GetJWTSecretName())
	if !ok {
		return true, nil
	}
	...
	if ok, err := licenseV2Compare(ctx, log, client, l.V2); err != nil {
...
func licenseV2Compare(ctx context.Context, log zerolog.Logger, client client.Client, license k8sutil.License) (bool, error) {
