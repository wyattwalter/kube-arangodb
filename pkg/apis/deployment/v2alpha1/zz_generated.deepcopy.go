...
func (in *DeploymentStatusLicense) DeepCopyInto(out *DeploymentStatusLicense) {
	*out = *in
	if in.V2 != nil {
		in, out := &in.V2, &out.V2
		*out = new(DeploymentStatusLicenseDetails)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentStatusLicenseDetails) DeepCopyInto(out *DeploymentStatusLicenseDetails) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentStatusLicenseDetails.
func (in *DeploymentStatusLicenseDetails) DeepCopy() *DeploymentStatusLicenseDetails {
	if in == nil {
		return nil
	}
	out := new(DeploymentStatusLicenseDetails)
